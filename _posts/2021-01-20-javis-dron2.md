...
를 순서로 하였을 때 사양에 맞춰가기 편리하여 위의 순서와 같이 부품을 정하였다.  
 ...
 먼저 우리가 사용할 프레임은 F450 쿼드 콥터 프레임으로
  ...
  <img src="/assets/img/프레임.png" width="110%" height="110%" title="px(픽셀) 크기 설정"alt="프레임">
...
위의 프레임에서는 2212모터를 지원하기 때문에 (프레임과 모터가 조립될 부분의 지름을 고려) 모터는 2212모터를 정하였다.
 ...
 <img src="/assets/img/모터.png"  width="110%" height="110%" title="px(픽셀) 크기 설정" alt="모터">
...
드론의 두뇌가 되는 FC 는 아두이노 우노로
 ...
 <img src="/assets/img/우노1.png" width="110%" height="110%" title="px(픽셀) 크기 설정" alt="우노">
...
-FWM신호를 받아 모터를 제어하는 역할로 모터를 제어하기 위해서는 꼭 필요하다.
 ...
 <img src="/assets/img/esc.png" width="110%" height=110%" title="px(픽셀) 크기 설정"alt="esc">
...
<img src="/assets/img/프로펠러.png" width="110%" height="110%" title="px(픽셀) 크기 설정"alt="프로펠러">
...
<img src="/assets/img/배터리.png" width="110%" height="110%" title="px(픽셀) 크기 설정"alt="배터리">
